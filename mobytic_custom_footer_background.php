...
class Mobytic_custom_footer_background extends Module
{
    protected $config_form = false;

    public function __construct()
    {
        $this->name = 'mobytic_custom_footer_background';
        ...
        $this->displayName = $this->l('Mobytic - Custom - Footer Background');
        $this->description = $this->l('Module permettant de modifier l\'arrière plan du footer');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MOBYTIC_CUSTOM_FOOTER_BACKGROUND_LIVE_MODE', false);
    ...
    public function installTab()
    {
        ...
        $tab->name = array();
        foreach (Language::getLanguages() as $lang) {
            $tab->name[$lang['id_lang']] = "Footer Background";
        }
    ...
    public function uninstall()
    {
        ...
        Configuration::deleteByName('MOBYTIC_CUSTOM_FOOTER_BACKGROUND_LIVE_MODE');
    ...
    public function getContent()
    {
        ...
        $output .= $this->uploadFileConditions('MOBYTIC_CUSTOM_FOOTER_BACKGROUND_BG_IMG');

        $this->context->smarty->assign('module_dir', $this->_path);

        $output .= $this->context->smarty->fetch($this->local_path.'views/templates/admin/configure.tpl');

        $output .= $this->renderForm($this->getConfigForm(), $this->getConfigFormValues(), 'submitMobytic_custom_footer_background_submit_btn');
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'MOBYTIC_CUSTOM_FOOTER_BACKGROUND_LIVE_MODE',
                        'is_bool' => true,
                        'desc' => $this->l('utiliser ce module'),
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => true,
                    ...
                    array(
                        'type' => 'file',
                        'desc' => $this->l('Séléctionner une image pour le FOOTER'),
                        'name' => 'MOBYTIC_CUSTOM_FOOTER_BACKGROUND_BG_IMG',
                        'label' => $this->l('Image'),
                        'display_image' => true,
                        'image' => $this->displayImgInForm('MOBYTIC_CUSTOM_FOOTER_BACKGROUND_BG_IMG'),
                    ),
                    array(
                        'type' => 'color',
                        'name' => 'MOBYTIC_CUSTOM_FOOTER_BACKGROUND_COLOR_A',
    ...
    */
    ...
    public function hookDisplayHeader()
    {
        ...
        if (Configuration::get('MOBYTIC_CUSTOM_FOOTER_BACKGROUND_LIVE_MODE') == true) {
            return $this->display(__FILE__, 'mobytic_background.tpl');
        }
    }
    ...
    {
        if (((bool)Tools::isSubmit('submitMobytic_custom_footer_background_submit_btn')) == true) {
    ...
    protected function checkUploadFile($img_uploaded)
    {
        if (isset($_FILES[$img_uploaded])) {
            ...
            if (in_array($file_ext, $allowed)) {
                move_uploaded_file($_FILES[$img_uploaded]['tmp_name'], dirname(__FILE__) . DIRECTORY_SEPARATOR . 'views\img' . DIRECTORY_SEPARATOR . $_FILES["MOBYTIC_CUSTOM_FOOTER_BACKGROUND_BG_IMG"]["name"]);
